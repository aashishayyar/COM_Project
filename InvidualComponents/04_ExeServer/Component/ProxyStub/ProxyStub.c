...
static const ProxyStub_MIDL_PROC_FORMAT_STRING ProxyStub__MIDL_ProcFormatString =
	...
	/* Procedure SubtractinOfTwoIntegers */
...
/* Object interface: IAddSubtract, ver. 0.0,
   GUID={0xA3A50D32,0x58B3,0x4897,{0xA4,0x47,0xDC,0x8B,0x93,0x5E,0xFB,0x94}} */
...
/* Object interface: IMultiplyDivide, ver. 0.0,
   GUID={0x4D44D171,0x6898,0x4C54,{0xBD,0xEF,0x83,0x02,0xEA,0x46,0xAC,0xBA}} */
...
CINTERFACE_PROXY_VTABLE(4) _IMultiplyDivideProxyVtbl = 
{
    ...
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IMultiplyDivide::SubtractinOfTwoIntegers */
};
